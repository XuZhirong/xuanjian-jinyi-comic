...
title: 果位之争
aspect: 3:4
output: assets/pages/16-cheng-huan-fruit-seat.png
---
...
PAGE 16: 果位之争
Timeline role: 程圜之战
Source anchor: 正文157-164行
Scene: 天外金德战场，程圜站在正统金色曼荼罗中，太元的白金兑光从四方逼近；双方不做夸张武打，而是整个金位法则在倾斜。
Silent visual bridge: 读者应从程圜的正统金座和太元逼近的兑光看懂：这是果位席位争夺。
...
- Make the page visually powerful even before reading the text: 前辈…前辈虽然不常参与世俗，可前辈与我也算有交情。 / 程圜…这是果位之争。
